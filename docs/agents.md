...
For an authorized change, edit and push the application's authoritative Compose
...
establish a successful explicit deployment before enabling automation. Use the
same CLI as the timer. Never classify a database as stateless to bypass backup.
